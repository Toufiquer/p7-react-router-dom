  ...
  return (
    <div className={`min-h-screen ${backgroundII} relative p-4`}>
      <div className={` ${border} min-h-[430px] sticky ${scrollDirection !== "down" ? "top-[65px]" : "top-[10px]"} `}>
        <h2 className={`${text} text-center text-2xl my-2`}>Users Carts</h2>
        <div className="flex flex-col"></div>
        <div className="absolute bottom-0 left-0 w-full p-4 ">
          <DetailsPage className="h-4 flex justify-center " path="/users/usersOutLet" navigate={navigate}>
            <h2 className="inline">View In OutLet</h2>
