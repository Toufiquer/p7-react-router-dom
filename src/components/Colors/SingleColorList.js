...
const SingleColorList = ({ data }) => {
  const styleColor = "flex h-8 w-[280px] my-4 pl-2 cursor-pointer justify-between border-2 border-solid border-blue-800 items-center justify-center";
  const dataArr = [];
    ...
    <>
      <ul>
        <li className={styleColor + "  uppercase w-full bg-blue-400"}>
          <p className="text-center w-full">{data.modelNumber}</p>
        </li>
